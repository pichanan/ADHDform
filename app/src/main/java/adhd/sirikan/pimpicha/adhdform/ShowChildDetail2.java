...
public class ShowChildDetail2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                objMyAlert.myDialog("คำแนะนำ(ไม่ใช่การวินิจฉัย ในการตัดสินปัญหาเด็ก)หากต้องการพบแพทย์ ควรบันทึกผลการประเมินเบื้องต้นเป็น PDF เพื่อประกอบการวินิจฉัย :","คะแนน\t<=50 อยู่ในเกณฑ์ปกติ\n\n"+
    ...
    private void analyzeRisk() {
        ...
        textView.setText("อาการซน/วู่วาม:"+risk1Int+" คะแนน"+"\n"+"อาการขาดสมาธิ:"+risk2Int+" คะแนน"+"\n"+"อาการรวม:"+risk3Int+" คะแนน"+"\n"+allrisk);
