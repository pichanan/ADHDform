...
public class riskThassActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                objMyAlert.myDialog("คำแนะนำ(ไม่ใช่การวินิจฉัย ในการตัดสินปัญหาเด็ก)",
    ...
    private void analyzeRisk() {
        ...
        if (risk3Int >= risk2Int && risk3Int >= risk1Int) {
            if(risk3Int>=51&&risk3Int<=60){//1 ควรเฝ้าระวัง ติดตาม ทำแบบคัดกรองซ้ำ
                textView.setText("=> อาการโดยรวม: อาจมีความเสี่ยง");
                allrisk = "=> อาการโดยรวม: อาจมีความเสี่ยง";
                //txtRisk3 = "=> อาการโดยรวม: อาจมีความเสี่ยง";

            }else if(risk3Int>=61&&risk3Int<=70){
                textView.setText("=> อาการโดยรวม: เริ่มมีความเสี่ยง");
                allrisk = "=> อาการโดยรวม: เริ่มมีความเสี่ยง";
                ...
                textView.setText("=> อาการโดยรวม: มีความเสี่ยสูง");
                allrisk = "=> อาการโดยรวม: มีความเสี่ยสูง";
                //txtRisk3 = "=> อาการโดยรวม: มีความเสี่ยสูง";
            }else{
                textView.setText("=>อยู่ในเกณฑ์ปกติ");
                allrisk = "=> อาการโดยรวม: อยู่ในเกณฑ์ปกติ";
            }
        }else if(risk1Int>=risk2Int&&risk1Int>=risk3Int){
            if(risk1Int>=51&&risk1Int<=60){//1 ควรเฝ้าระวัง ติดตาม ทำแบบคัดกรองซ้ำ
                textView.setText("=> อาการซน/วู่วาม: อาจมีความเสี่ยง");
                allrisk = "=> อาการซน/วู่วาม: อาจมีความเสี่ยง";
            }else if(risk1Int>=61&&risk1Int<=70){
                textView.setText("=> อาการซน/วู่วาม: เริ่มมีความเสี่ยง");
                allrisk = "=> อาการซน/วู่วาม: เริ่มมีความเสี่ยง";
                ...
                textView.setText("=> อาการซน/วู่วาม: มีความเสี่ยงสูง");
                allrisk = "=> อาการซน/วู่วาม: มีความเสี่ยงสูง";
            }else{
                textView.setText("=>อยู่ในเกณฑ์ปกติ");
                allrisk = "=>อยู่ในเกณฑ์ปกติ";
            }
        } else if (risk2Int >= risk1Int && risk2Int >= risk3Int) {
            if(risk2Int>=51&&risk2Int<=60){//1 ควรเฝ้าระวัง ติดตาม ทำแบบคัดกรองซ้ำ
                textView.setText("=> อาการขาดสมาธิ: อาจมีความเสี่ยง");
                allrisk = "=> อาการขาดสมาธิ: อาจมีความเสี่ยง";
            }else if(risk2Int>=61&&risk2Int<=70){
                textView.setText("=> อาการขาดสมาธิ: เริ่มมีความเสี่ยง");
                allrisk = "=> อาการขาดสมาธิ: เริ่มมีความเสี่ยง";
                ...
                //txtRisk1 = "=> อาการซน/วู่วาม: เริ่มมีความเสี่ยง";
                textView.setText("=> อาการขาดสมาธิ: มีความเสี่ยงสูง");
                allrisk = "=> อาการขาดสมาธิ: มีความเสี่ยงสูง";
            }else{
                textView.setText("=>อยู่ในเกณฑ์ปกติ");
                allrisk = "=>อยู่ในเกณฑ์ปกติ";
            }
