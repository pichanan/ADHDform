...
public class GraphActivity extends AppCompatActivity { // SNAP
    ...
    private void calCorre2() {
        ...
        if(r>=0.9&&r<=1.0){
            txtCorre.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับตสูงมาก");
        }else if(r>=0.7&&r<=0.9){
            txtCorre.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับสูง");
        }else if(r>=0.5&&r<=0.7){
            txtCorre.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับปานกลาง");
        }else if(r>=0.3&&r<=0.5){
            txtCorre.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับต่ำ");
        }else if(r>=0.0&&r<=0.3){
            txtCorre.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับต่ำมาก");
        }else{
            txtCorre.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันแบบตรงข้ามกัน");
