...
public class Graph2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createLineGraphBlue1("1","risk2",colorLineInts[1]);//thass risk1 Parent

        //*risk2**************************************/
        createLineGraphRed2("1","risk2",colorLineInts[0]);// snap risk2 Parent
        createLineGraphBlue2("1","risk1",colorLineInts[1]);//thass risk2 Parent
        calCorre1();
        calCorre2();
    }
    ...
    private void calCorre2() {
        ...
        if(r>=0.9&&r<=1.0){
            txtCorre2.setText("ด้านอาการซนวู่วาม ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับสูงมาก");
        }else if(r>=0.7&&r<=0.9){
    ...
    private void calCorre1() {
        ...
        if(r>=0.9&&r<=1.0){
            txtCorre.setText("ด้านอาการขาดสมาธิ ค่าที่หาได้คือ:"+s+" หมายความว่า มีความสัมพันธ์กันในระดับสูงมาก");
        }else if(r>=0.7&&r<=0.9){
